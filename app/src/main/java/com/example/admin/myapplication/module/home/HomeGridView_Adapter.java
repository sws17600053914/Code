...
public class HomeGridView_Adapter extends BaseAdapter{

    Context context;
    ArrayList<HomeDataBean.DataBean.PandaliveBean.ListBean> list;
    public HomeGridView_Adapter(Context context, ArrayList<HomeDataBean.DataBean.PandaliveBean.ListBean> list) {
